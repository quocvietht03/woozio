      ...
      public static function enqueue_admin_assets( $hook ) : void {
          ...
          wp_localize_script(
              ...
              [
                  ...
                  'strings'  => [
                      'confirm_import'            => __( 'Please activate the Theme License to unlock Demo Import, Plugin updates, and Official Support.', 'woozio' ),
                      'deactivate_confirm'        => __( 'Are you sure you want to deregister this license on this site?', 'woozio' ),
                      'please_enter_purchase_code'=> __( 'Please enter a purchase code.', 'woozio' ),
                      'ajax_error'                => __( 'AJAX error. Please try again.', 'woozio' ),
                      'verifying'                 => __( 'Verifying...', 'woozio' ),
                      'processing'                => __( 'Processing...', 'woozio' ),
                      'license_activated'         => __( 'License activated.', 'woozio' ),
                      'license_deactivated'       => __( 'License deactivated.', 'woozio' ),
                      'activation_failed'         => __( 'Activation failed.', 'woozio' ),
                      'deactivation_failed'       => __( 'Deactivation failed.', 'woozio' ),
                      'too_many_attempts'         => __( 'Too many attempts. Try again later.', 'woozio' ),
                      'unauthorized'              => __( 'Unauthorized', 'woozio' ),
                  ],
              ]
          );
      }
