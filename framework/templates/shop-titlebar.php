...
if (isset($_GET['titlebar'])) {
  $shop_title_bar['select_titlebar'] = sanitize_text_field($_GET['titlebar']);
}
if (isset($_GET['breadcrumb_position'])) {
  $shop_title_bar['breadcrumb_position'] = sanitize_text_field($_GET['breadcrumb_position']);
}
if (isset($_GET['enable_description'])) {
  $shop_title_bar['enable_description_titlebarshop'] = filter_var($_GET['enable_description'], FILTER_VALIDATE_BOOLEAN);
}
if (isset($_GET['enable_background'])) {
  $shop_title_bar['enable_background_titlebarshop'] = filter_var($_GET['enable_background'], FILTER_VALIDATE_BOOLEAN);
}
if (isset($_GET['enable_section_bottom'])) {
  $shop_title_bar['enable_section_bottom_titlebarshop'] = filter_var($_GET['enable_section_bottom'], FILTER_VALIDATE_BOOLEAN);
}
if (isset($_GET['section_bottom_id'])) {
  $section_id = absint($_GET['section_bottom_id']);
